...
do
    ...
    python init_base_model.py --arch ${ARCH} --train_epoch 50 --train_data_name tinyimagenet --lr 0.001 --batch_size 128 --seed 1 --gpu ${gpu} --cifar_data_path ../datasets/Tiny-ImageNet/tiny-imagenet-200 --cifar_corruption_path ../datasets/Tiny-ImageNet/Tiny-ImageNet-C
done
